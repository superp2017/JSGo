...
func Redis_expire(k string, v interface{}, t int) error {
	...
	if e != nil {
		Error("expire  Table【%s】，error:%v", k, e.Error())
		return e
	}
...
func Redis_get(k string, v interface{}) error {
	...
	if e != nil {
		Error("get  Table【%s】，error:%v", k, e.Error())
		return e
	}
...
func Redis_set(k string, v interface{}) error {
	...
	_, e = c.Receive()
	if e != nil {
		Error("set Table【%s】，error:%v", k, e.Error())
		return e
	}
	return nil
}
...
func Redis_exists(k string) (bool, error) {
	...
	if e != nil {
		Error("exists Table【%s】，error:%v", k, e.Error())
		return false, e
	}
	return b, nil
}
...
func Redis_del(k string) error {
	...
	_, e := c.Receive()
	if e != nil {
		Error("del Table【%s】，error:%v", k, e.Error())
		return e
	}
	return nil
}
...
func Redis_hget(t, k string, v interface{}) error {
	...
	b, e := redis.Bytes(c.Receive())
	if e != nil {
		Error("hget Table【%s】,Key【%s】，error:%v", t, k, e.Error())
		return e
	}
	e = json.Unmarshal(b, v)
	if e != nil {
...
func Redis_hset(t, k string, v interface{}) error {
	...
	_, e = c.Receive()
	if e != nil {
		Error("hset Table【%s】,Key【%s】，error:%v", t, k, e.Error())
		return e
	}
	return nil
}
...
func Redis_hexists(t, k string) (bool, error) {
	...
	b, e := redis.Bool(c.Receive())
	if e != nil {
		Error("hexists Table【%s】,Key【%s】，error:%v", t, k, e.Error())
		return false, e
	}
...
func Redis_hsize(t string) (int64, error) {
	...
	if e != nil {
		Error("hsize Table【%s】,error:%v", t, e.Error())
		return -1, e
	}
...
func Redis_hkeys(t string) ([]string, error) {
	...
	if e != nil {
		Error("hkeys Table【%s】,error:%v", t, e.Error())
		return nil, e
	}
...
func Redis_hdel(t, k string) error {
	...
	_, e := c.Receive()
	if e != nil {
		Error("hdel Table【%s】,Key【%s】，error:%v", t, k, e.Error())
		return e
	}
...
func Redis_hmget(t string, ret *map[string]interface{}) error {
	...
	for _, k := range keys {
		...
		b, e := redis.Bytes(c.Receive())
		if e != nil {
			Error("hmget Table【%s】,Key【%s】，error:%v", t, k, e.Error())
			return e
		}
...
func Redis_Sset(k string, v interface{}) error {
	...
	_, e := c.Receive()
	if e != nil {
		Error("Sset Table【%s】，error:%v", k, e.Error())
		return e
	}
	return nil
}
...
func Redis_Sget(k string) ([]interface{}, error) {
	...
	if e != nil {
		Error("Sget Table【%s】，error:%v", k, e.Error())
	}
	return re, e
}
...
func Redis_Sdel(t string, k interface{}) error {
	...
	_, e := c.Receive()
	if e != nil {
		Error("Sdel Table【%s】，error:%v", k, e.Error())
		return e
	}
	return nil
}
